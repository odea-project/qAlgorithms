...
EICs <- qBinning(path = "../../rawdata/qCentroid_Warburg_pos_171123_01_Zu_01.csv",minBinsize = 5)
Rprof (NULL) ; print(summaryRprof(tf))

#write.csv(EICs, file = "../../rawdata/control_bins.csv", row.names = FALSE)
print("done")

Rprof(tf_read <- "log.log", memory.profiling = TRUE)
xt22 <- data.table::fread(file = "../../rawdata/qCentroid_Warburg_pos_171123_01_Zu_01.csv",sep = ",") 
Rprof (NULL) ; print(summaryRprof(tf_read))
```
