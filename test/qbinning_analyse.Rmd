...
ggplot(summary_error[which(summary_error$errorcode == 10000),])+ #[which(summary_error$errorcode == 10000),]
  geom_point(aes(x = mean_mz, y = mean_scans, colour = log10(meanError)))+
