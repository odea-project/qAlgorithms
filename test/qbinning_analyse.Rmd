...
ggplot(summary_error[summary_error$errorcode - round(summary_error$errorcode, -5) >= 10000,])+ #[which(summary_error$errorcode == 10000),]
  geom_point(aes(x = mean_mz, y = mean_scans, colour = size))+
