...
2.C++: Calculate critval and multiply with error in that region - generated by substracting 
	beginning from end in the relevant range
2.R: Calculate critval only depending on size of bin
-> multiple possile sources of floating point errors
