...
selectedProcess = allProcessed[c(93:107, 120:129), ] # allProcessed[c(1:44, 120:129), ]
...
for (i in 1:length(display_b0)) {
  display_devs$min[i] = min(display_b1[i] / sd_bin1, display_b0[i] / sd_bin0, display_b2[i] / sd_bin2)
  display_devs$max[i] = max(display_b1[i] / sd_bin1, display_b0[i] / sd_bin0, display_b2[i] / sd_bin2)
  display_devs$mean[i] = mean(display_b1[i] / sd_bin1, display_b0[i] / sd_bin0, display_b2[i] / sd_bin2)
}
...
#   geom_point(aes(row.names(selectedProcess), display_b0 / sd_bin0, colour = series, shape = "None"))+
#   scale_x_discrete(guide = guide_axis(angle = 60))
