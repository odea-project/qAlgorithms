...
For in-depth details, the outcomes of all processing steps are preserved within the
output and every feature can be traced back to the profile points that produced it.
...
to reduce the difficulty for chemists, who are generally inexperienced programmers, in reading
