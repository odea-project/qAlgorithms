...
curve_S_M = function(x){ # merged curve with apex at x = rt and height = 1
  ...
  b0_n1 = mean(b0_n1_A, b0_n1_B)
  b1_n1 = mean(b0_n1_A, b0_n1_B)
  b0_n2 = mean(b0_n1_A, b0_n1_B)
  b1_n2 = mean(b0_n1_A, b0_n1_B)
  b2_m = mean(feature_A$b2, feature_B$b2)
  b3_m = mean(feature_A$b3, feature_B$b3)
  # the new apex position is also the mean of both previous apex positions
  offset = mean(offset_A, offset_B)
  side = x < offset
