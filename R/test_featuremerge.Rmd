...
curve_A = peakShape(rts, feature_A$retentionTime + feature_A$rt_switch, feature_A$b0, feature_A$b1, feature_A$b2, feature_A$b3)
```

```{r}
ggplot(rbind(points_A, points_B))+
  geom_point(aes(retentionTime, area, colour = as.factor(round(mz))))
