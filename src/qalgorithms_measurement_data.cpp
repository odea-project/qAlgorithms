        ...
        for (auto& pair : *arg)
        {
          ...
          if (dataPoints.size() > 0)
            ...
            while (flag < 3)
            {
              ...
              {
                xDataTemp.push_back(dataPoints[i]->x());
            ...
            while (flag < 3)
            {
              ...
              {
                xDataTemp.push_back(dataPoints[j]->x());
            ...
            {
              dataPoints[j]->setY(exp(B(0, 0) + B(1, 0) * dataPoints[j]->x() + B(2, 0) * dataPoints[j]->x() * dataPoints[j]->x()));
              dataPoints[j]->df = 0;
              // check if the interpolated value is larger than 3 * MAX
            ...
            for (int i = I; i <= J; i++)
            {
              if (dataPoints[i]->y() == 0.0)
              {
                ...
                while (flag < 2)
                {
                  ...
                  {
                    xDataTemp.push_back(dataPoints[k]->x());
                ...
                while (flag < 2)
                {
                  ...
                  {
                    xDataTemp.push_back(dataPoints[l]->x());
                ...
                for (int n = i; n < j; n++)
                {
                  dataPoints[n]->setY(exp(B(0, 0) + B(1, 0) * dataPoints[n]->x() + B(2, 0) * dataPoints[n]->x() * dataPoints[n]->x()));
                  dataPoints[n]->df = 0;
                  // check if the interpolated value is larger than 3 * MAX
