...
#pragma region helpstring
    ...
    const char VERSION[] = "qAlgorithms v1.0.0";

    const char helpinfo[] =
        " Basic Usage:\n\n"
        " ./qAlgorithms -i [input file] -o [output directory] -pa\n\n"
        ...
        //   "      -tl, --tasklist <PATH>:      (@todo) pass a list of file paths to the function. A tasklist can also contain directories\n"
        ...
        "      --skip-ahead <n>           : Skip the first n entries in the tasklist when starting processing \n"
...
#pragma region "command line arguments"
    ...
    UserInputSettings passCliArgs(const int argc, const char *argv[])
    {
        ...
        for (int i = 1; i < argc; i++)
        {
            ...
            else if (argument == "--log") // @todo if logging is off by default, nobody who would benefit from it will turn it on
            {
                args.doLogging = true;
            }
