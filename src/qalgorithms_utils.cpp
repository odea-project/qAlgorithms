...
namespace q
{
  ...
  {
    double a = 0.978795604954049; // empirically determined
    double b = 1.25731022692317; // empirically determined
    double t = -x * x;
    return SQRTPI_2 * exp_approx(t) + sign * a * x * exp_approx(t * b);
  }
