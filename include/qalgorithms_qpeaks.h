...
/* This file includes the qPeaks class*/
namespace qAlgorithms
{
     ...
     *
     * @param df : Matrices::Vector of integers that indicates if the data point is interpolated or not
