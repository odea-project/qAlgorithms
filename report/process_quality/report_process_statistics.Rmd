...
The DQSB in its current implementation [@reuschenbachQBinningDataQualityBased2023] gives a measure of how well separated
...
as is a [detailed description of the binning algorithm](https://github.com/odea-project/qAlgorithms/tree/qBinning_beta/report/report.md).
...
### Hide Pressure Curves


### Show Pressure Curves

```{r pressure plot, echo=FALSE}
knitr::include_graphics("./pump_pressure_david_08-08.jpg")
```
Green checkmarks denote the datasets that could be converted to .MZml successfully.
